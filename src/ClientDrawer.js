...
const ClientDrawer = ({ isOpen, closeDrawer, saveClient, client, fetchClients }) => {
    ...
    const handleSubmit = (e) => {
        ...
        const url = client ? `${hostaddress}/client/${client.client_id}` : `${hostaddress}/client`;
    ...
    return (
        <div className="fixed right-0 top-0 w-96 h-full bg-white shadow-lg z-50 p-4">
            <h2 className="text-lg font-semibold">{client ? 'Edit Client' : 'Add New Client'}</h2>
